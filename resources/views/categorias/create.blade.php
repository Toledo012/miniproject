<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h1 class="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Nueva categoria</h1>
        </div>
    </x-slot>
            ...
            <div class="glass-card p-6 sm:p-8">
                <form method="POST" action="{{ route('categorias.store') }}" class="space-y-6">
                    ...
                    <div class="flex flex-wrap gap-3 border-t border-slate-200/70 pt-6">
                        <button type="submit" class="raph-button-primary">Guardar categoria</button>
